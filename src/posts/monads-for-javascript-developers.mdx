...
<PostExercise>
Now it's your turn. <EditorPaneLink codeId="with-log-monad">Open this exercise</EditorPaneLink> and try implementing <PostExerciseInlineCode>runWithLog</PostExerciseInlineCode> using both <PostExerciseInlineCode>wrap</PostExerciseInlineCode> and <PostExerciseInlineCode>bind</PostExerciseInlineCode>.
...
<PostExercise>
Exercise time! Try <EditorPaneLink codeId="monad-maybe">implementing <PostExerciseInlineCode>wrap</PostExerciseInlineCode> and <PostExerciseInlineCode>bind</PostExerciseInlineCode></EditorPaneLink> for <PostExerciseInlineCode>Maybe</PostExerciseInlineCode>.
